...
from yolodetection.settings import BASE_DIR

confthres=0.5
nmsthres=0.1
path= os.path.join(BASE_DIR,'YOLO')
...
def run():
    ...
    path = os.path.join(BASE_DIR, 'media/input/test.jpg')
    print("Path: " + str(path))
    try:
    ...
    cv2.imwrite(os.path.join(BASE_DIR, 'media/output/testoutput.jpg'),res)
    return